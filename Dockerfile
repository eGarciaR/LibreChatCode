...
# ca-certificates is required for curl to verify GitHub's HTTPS cert.
# node:20-slim does not ship it, and --no-install-recommends won't pull it in,
# so it must be listed explicitly (this was the cause of the curl: (77) error).
